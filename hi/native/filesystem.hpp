...
namespace fs {
    namespace native {
        ...
        IO_NODISCARD inline bool stat(const char* utf8_path, file_type& outType, u64* outSize) noexcept;
        IO_NODISCARD inline bool create_directory(const char* utf8_path) noexcept;
        
        // Delete EMPTY directory or a file
        IO_NODISCARD inline bool remove(const char* utf8_path) noexcept;
        IO_NODISCARD inline bool rename(const char* utf8_from, const char* utf8_to) noexcept;
        IO_NODISCARD inline bool current_directory(io::string& out_utf8) noexcept;

        // ----- Directory job -----

        // Returns nullptr on error.
        IO_NODISCARD inline dir_handle* open_dir(const char* utf8_path) noexcept;
        ...
        // Helper function to work with paths.
        // join_path("dir", "file", out, cap) -> "dir/file"
        inline void join_path(const char* base,
                              const char* name,
                                    char* outPath,
                                    usize outCapacity) noexcept;
    } // namespace native
} // namespace fs
